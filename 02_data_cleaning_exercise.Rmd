...
2. Add the data you collected in the field and data from other sources if you have. You will need to standardize column names (`read_csv`, `select`, `bind_rows`).
...
6. Check for problems with coordinate precision (`clean_dataset`). 
7. Visualize the difference between the unclean and cleaned dataset (`plot`)
